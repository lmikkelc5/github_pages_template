...
![Graph showing how the correlation between income and smartphone ownership has decresased from 2021 - 2023](..\imgs\incomevssmartphone.png)

### Final Dataset info information about final dataset (e.g., total sample size, counts of categorical variables, numerical summaries of numeric variables)
